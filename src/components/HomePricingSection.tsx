...
export const HomePricingSection = () => {
  ...
  const services = [
    { id: "forex" as const, name: "Forex", icon: TrendingUp, pricing: forexPricing },
    { id: "crypto" as const, name: "Crypto", icon: Bitcoin, pricing: cryptoPricing },
    { id: "comex" as const, name: "Comex", icon: Coins, pricing: comexPricing },
    { id: "indices" as const, name: "Indices", icon: BarChart3, pricing: indicesPricing }
  ];
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${
                    selectedService === service.id
                      ...
                      : "bg-card text-foreground border border-border hover:border-primary hover:scale-105"
                  }`}
                >
                  <Icon size={20} />
                  {service.name}
